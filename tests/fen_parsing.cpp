...
protected:
    virtual void add_inline_data() override {
        ...
        inline_data({ "8/8/8/8/8/8/8/8 b - - 0 1" });
        inline_data({ "8/8/8/8/8/8/8/8 w Qq - 0 1" });
        inline_data({ "8/8/8/8/8/8/8/8 w Kk - 0 1" });
        inline_data({ "8/8/8/8/8/8/8/8 w - a1 0 1" });
        inline_data({ "8/8/8/8/8/8/8/8 w - h8 0 1" });
        inline_data({ "8/8/8/8/8/8/8/8 w - - 10 1" });
        inline_data({ "8/8/8/8/8/8/8/8 w - - 0 10" });
    }
    ...
    virtual std::string get_check_name() override { return "valid_fen_strings"; }
};
...
protected:
    ...
    virtual std::string get_check_name() override { return "invalid_fen_strings"; }
};
